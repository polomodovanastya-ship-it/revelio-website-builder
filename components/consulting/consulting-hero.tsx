...
import consultingHeroAsset from '@/assets/consulting-hero.png.asset.json'
    ...
    <section className="relative overflow-hidden border-b border-border pt-28 pb-16 sm:pt-36 sm:pb-24">
      ...
      <div className="relative mx-auto max-w-7xl px-5 sm:px-8">
        <div className="grid gap-8 lg:grid-cols-2 lg:items-start">
          ...
          <div
            className="reveal in-view relative aspect-[4/3] w-full overflow-hidden rounded-2xl border border-border lg:mt-0 lg:aspect-auto lg:min-h-[360px]"
            style={{ animationDelay: '120ms' }}
          >
            <Image
              src={consultingHeroAsset.url}
