...
export function MediaCard({ item }: { item: MediaItem }) {
  ...
  return (
    <article className="group block">
      <div className="safari-no-hover flex flex-col overflow-hidden rounded-2xl border border-border bg-card transition-[transform,box-shadow,border-color] duration-300 will-change-transform group-hover:-translate-y-0.5 group-hover:border-primary/25 group-hover:shadow-[0_14px_36px_-20px_rgba(20,37,80,0.28)]">
        {item.coverSrc && (
