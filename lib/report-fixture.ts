...
export const reportFixture: ReportData = {
  ...
  risks: [
    { risk: "Срок 3 месяца при ~3 900 ч", impact: "Высокое", comment: "Нужен MVP-scope или расширение команды" },
    { risk: "72 из 94 задач без полного контекста", impact: "Среднее", comment: "Оценка уточняется после интервью" },
    { risk: "14 интеграционных задач — низкая точность", impact: "Среднее", comment: "AD, Trino, LLM — зависят от контура заказчика" },
    { risk: "Недокументированный пилот", impact: "Высокое", comment: "Увеличивает время архитектурного анализа" },
    { risk: "Качество данных в Trino", impact: "Среднее", comment: "Ответственность заказчика по ТЗ" },
    { risk: "Мультиагентная оркестрация", impact: "Среднее", comment: "Маршрутизация, контекст, качество ответов" },
    { risk: "Часть задач оценена без plan-fact истории", impact: "Низкое", comment: "Широкий диапазон min–max" },
  ],
  assumptions: [
