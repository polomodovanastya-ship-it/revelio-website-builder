...
export const reportFixture: ReportData = {
  ...
  tasks: [
    { task_id: "T1", group: "Инфраструктура", title: "Реализация требований информационной безопасности", min: 80, expected: 120, max: 160, accuracy: "Средняя" },
    { task_id: "T2", group: "Инфраструктура", title: "Подготовка инфраструктуры для масштабирования", min: 60, expected: 100, max: 140, accuracy: "Средняя" },
    { task_id: "T3", group: "Инфраструктура", title: "Контейнеризация и подготовка к развёртыванию", min: 60, expected: 100, max: 140, accuracy: "Средняя" },
    { task_id: "T4", group: "Разработка функциональности", title: "Разработка ядра мультиагентной платформы", min: 80, expected: 120, max: 160, accuracy: "Средняя" },
    { task_id: "T5", group: "Разработка функциональности", title: "ИИ-ассистент для анализа операций РЦ", min: 40, expected: 64, max: 88, accuracy: "Средняя" },
    { task_id: "T6", group: "Разработка функциональности", title: "Аутентификация и авторизация", min: 48, expected: 72, max: 96, accuracy: "Высокая" },
    { task_id: "T7", group: "Интеграции", title: "Интеграция с LLM-моделями заказчика", min: 4, expected: 8, max: 16, accuracy: "Низкая" },
    { task_id: "T8", group: "Интеграции", title: "Интеграция с Trino для доступа к данным", min: 4, expected: 8, max: 16, accuracy: "Низкая" },
    { task_id: "T9", group: "Тестирование и QA", title: "Нагрузочное тестирование (300 пользователей)", min: 24, expected: 32, max: 40, accuracy: "Средняя" },
    { task_id: "T10", group: "Тестирование и QA", title: "ПСИ и совместное тестирование", min: 40, expected: 50, max: 60, accuracy: "Средняя" },
    { task_id: "T11", group: "Документация", title: "Руководство пользователя", min: 12, expected: 16, max: 20, accuracy: "Средняя" },
    { task_id: "T12", group: "Управление проектом", title: "Организация процессов технического сопровождения", min: 24, expected: 40, max: 56, accuracy: "Средняя" },
  ],
  roles: {
    total_expected: 3906,
    roles: [
