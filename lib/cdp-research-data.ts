...
export type MauTier = { range: string; stack: string[]; team: string[] }

export const MAU_TIERS: MauTier[] = [
  {
    range: 'до 500 000 MAU',
    stack: ['SaaS', 'желательно all-in-one', 'CDP и есть КХД'],
    team: ['2–5 человек', '5 в работе, 2 запускаем', 'Федералки', 'Сегменты по XX%'],
  },
  {
    range: '0,5 – 2 млн MAU',
    ...
    team: ['10–15 человек', 'можно пробовать цепочки', 'real-time пока не имеет смысла', 'дробить отток и онбординг на 10–30 сегментов'],
  },
  {
    range: 'по дороге к 10 млн MAU',
    stack: ['on prem / самописное', 'обязательно КХД в 2 слоя минимум', 'дробить на функции'],
    team: ['40 человек', 'моделирование большого', '«Тестирование на бою», кроме федералок', 'больше людей, ролевые модели', 'пробовать ML'],
  },
]
